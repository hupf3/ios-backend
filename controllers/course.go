...
func GetAllCourses(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"msg": "failed"})
		return
	}
	context.JSON(http.StatusOK, gin.H{"msg": "succeed", "data": data, "count": len(data)})
}
...
func CreateCourse(context *gin.Context) {
	...
	context.JSON(http.StatusOK, gin.H{"msg": "succeed"})
}
...
func GetCourseByID(context *gin.Context) {
	...
	context.JSON(http.StatusOK, gin.H{"msg": "succeed", "data": data})
}
